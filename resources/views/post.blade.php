                      ...
                      <div class="comment-list">
                        <div class="single-comment justify-content-between d-flex">
                          <div class="user justify-content-between d-flex">
                            <div class="thumb">
                              <img src="https://i.pinimg.com/474x/65/25/a0/6525a08f1df98a2e3a545fe2ace4be47.jpg" alt="{{$comment->user->image}}" width="50px">
                            </div>
                            <div class="desc">
                    ...
                    @if($comment->replies->count() > 0)
                      ...
                      <div class="comment-list left-padding">
                        ...
                        >
                          <div class="user justify-content-between d-flex">
                            <div class="thumb">
                              <img src="https://media-exp1.licdn.com/dms/image/C5603AQHHmaWlhqkphA/profile-displayphoto-shrink_200_200/0/1637374204241?e=1643241600&v=beta&t=NKGOPkL47hEmrzLmi51pQ_lFnMOJUaWHbPZwGbznE4c" alt="{{$reply->user->image}}" width="50px"/>
                            </div>
                            <div class="desc">
                    ...
                    @endif
                      ...
                      <div class="comment-list left-padding" id="reply-form-{{$comment->id}}" style="display: none">
                        ...
                        >
                          <div class="user justify-content-between d-flex">
                            <div class="thumb">
                              <img src="https://www.tenforums.com/geek/gars/images/2/types/thumb_15951118880user.png" alt="{{Auth::user()->image}}" width="50px"/>
                            </div>
                            <div class="desc">
