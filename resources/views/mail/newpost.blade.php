...
<body>
    <div class="container">
        <div class="navbar">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSCvzlMeYQpOrnLU-GUegrB8iw7SrECB_EOmQ&usqp=CAU" alt="logo" />
        </div>
    </div>
    <div class="container">
        <div class="post">
        ...
        <div class="footer">
            <p>This mail is from vaishbhalla1@gmail.com</p>
            <p>© <script>let t = new Date(); document.write(t.getFullYear());</script> vaishbhalla. All rights reserved.</p>
        </div>
    </div>
</body>
</html>